...
class DemoOptions():
    ...
    def __init__(self):
        ...
        parser.add_argument("--save_camera", action='store_true', help='Save the extracted camera position')
        parser.add_argument("--save_obj", action='store_true', help='Save the extracted body model to obj file')
